...
class ChordTrainer(MusicTheory):
    ...
    def __init__(self, picotts, p, chord_types = ['M7','7','-7']):
        super(ChordTrainer, self).__init__()
        self.picotts = picotts
        self.p = p 
        #self.inport = inport 
        self.pressed_notes = []
        self.chord_types_selected = chord_types
    ...
    def choose_random_chord(self,):
        ...
        chord_types_keys_total = list(self.chord_types.keys())
        chord_types_keys = [ chord_type for chord_type in self.chord_types_selected if chord_type in chord_types_keys_total] 
